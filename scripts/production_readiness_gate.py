...
def main() -> int:
    ...
    content_checks = {
        ...
        "deploy/production.env.example": [
            ...
            "MITRA_COMPANION_ENV_FILE",
            "MITRA_COMPANION_LOG_PATH=/data/production-runtime.jsonl",
            "MITRA_COMPANION_LOG_LEVEL=INFO",
        ...
        "pratham/companion-runtime/mitra_companion/runtime.py": [
            ...
            "record_product_exchange_receipt",
        ...
        "pratham/companion-runtime/mitra_companion/api.py": [
            ...
            "/api/v1/products/{product_id}/exchange-inbox",
        ...
        "pratham/companion-runtime/mitra_companion/production_logging.py": [
            "JsonRuntimeFormatter",
            "configure_production_logging",
            "production_log",
        ],
        "contracts/source-scope-catalog.json": [
            "persistent-production-runtime",
            "attached-product-exchange-mailbox",
